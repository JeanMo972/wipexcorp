...
/**
    ...
    public function findWithSearch(Search $search) {
        ...
        $query = $this
            ...
            ->select('c', 'p')
              // Je join la catégory dans la table product et category dans la table category
            ->join('p.category', 'c');
        ...
        if (!empty($search->categories)) {
            ...
            //si l'utilisateur renseigne un texte à rechercher
        ...
        //crée la requête et la retourne 
